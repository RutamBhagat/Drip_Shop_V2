...
const Navigation = () => {
  ...
  return (
    <Fragment>
      <nav className="fixed top-0 right-0 left-0 z-50 custom-gradient">
        <div className="bg-transparent">
          <div className="mx-auto flex items-center justify-between bg-transparent py-5 px-10 normal:px-3 md:px-10 lg:max-w-[90vw] xl:max-w-[80vw]">
            ...
            <div className="ml-auto hidden flex-row normal:flex">
              <h1 className="mr-5 py-2 text-gray-200 font-semibold hover:cursor-pointer hover:text-violet-700">
                CART
              ...
              {currentUser ? (
                <Link to="/">
                  <h1
                    onClick={signOutUser}
                    className="text-text-gray-600 rounded font-semibold bg-indigo-700 py-2 px-4 text-white hover:cursor-pointer"
                  >
                    SIGN OUT
                  </h1>
                </Link>
                ...
                <Link to="/signin">
                  <h1 className="text-text-gray-600 rounded font-semibold bg-indigo-700 py-2 px-4 text-white hover:cursor-pointer">
                    LOG IN
                  </h1>
                </Link>
              )}
