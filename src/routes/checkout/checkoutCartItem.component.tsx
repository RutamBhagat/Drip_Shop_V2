...
const CheckoutCartItem = ({ cartItem }: CheckoutCartItem) => {
  ...
  return (
    <div className="mx-1 my-1.5 flex w-full max-w-4xl rounded-lg p-1 shadow-lg">
      <div className="flex w-full justify-between">
        <div className="h-[250px] w-2/3 max-w-[250px]  rounded-l-lg">
          <img className="h-full w-full object-cover" src={imageUrl} />
        </div>
        <div className="flex h-[250px] w-2/3 max-w-[400px] flex-col justify-between p-3">
